...
/datum/action/cooldown/spell/conjure_item/psionic/psitool
	...
	button_icon = 'modular_void/code/modules/psionics/icons/psi_items.dmi'
...
/obj/item/psionic_omnitool
	...
	icon = 'modular_void/code/modules/psionics/icons/psi_items.dmi'
...
/obj/item/psionic_omnitool/Initialize(mapload)
	. = ..()
	tool_list = list(
			"Crowbar" = image(icon = 'modular_void/code/modules/psionics/icons/psi_items.dmi', icon_state = "crowbar"),
			"Screwdriver" = image(icon = 'modular_void/code/modules/psionics/icons/psi_items.dmi', icon_state = "screwdriver"),
			"Wirecutters" = image(icon = 'modular_void/code/modules/psionics/icons/psi_items.dmi', icon_state = "cutters"),
			"Wrench" = image(icon = 'modular_void/code/modules/psionics/icons/psi_items.dmi', icon_state = "wrench"),
		)
