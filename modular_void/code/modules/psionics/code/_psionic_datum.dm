...
/datum/psionic/proc/research_spell(datum/action/cooldown/spell/spell_path)
	...
	if(psi_point < initial(spell_path.point_cost))
		...
		return FALSE
	psi_owner.playsound_local(psi_owner.loc, 'modular_void/code/modules/psionics/sounds/power_evoke.ogg', 50, TRUE)
...
/datum/status_effect/psionic_exhaustion/on_apply()
	. = ..()
	instabilityicon = icon('modular_void/code/modules/psionics/icons/spells.dmi', "instability")
