...
/datum/action/psionic_shop
	name = "Psionic Shop"
	button_icon = 'modular_void/code/modules/psionics/icons/spells.dmi'
...
/datum/action/psionic_shop/Trigger(mob/clicker, trigger_flags)
	...
	clicker.playsound_local(clicker.loc, 'modular_void/code/modules/psionics/sounds/power_fabrication.ogg', 50, TRUE)
