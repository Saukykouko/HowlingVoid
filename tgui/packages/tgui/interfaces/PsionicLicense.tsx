        ...
        <Stack minWidth="625px">
          <Stack.Item width="100%">
            <Section textAlign="center">
              ...
              {
                ' Пользователь псионики обязан иметь лицензию при себе всё время. Использование псионики без лицензии считается владением контрабандой.'
              }
              {
                ' Псионик без лицензии должен быть имплантирован имплантом подавления псионики.'
              }
            </Section>
          </Stack.Item>
        </Stack>
